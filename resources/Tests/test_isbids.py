...
class test_bids(unittest.TestCase):
    ...
    def test_bids_dataset_1(self):
        names=list()
        test1=PATH+"/Tests/DataSets/ds001/Data"
        dic_data = json.loads(
    ...
    def test_bids_dataset_2(self):
        names=list()
        test1=PATH+"/Tests/DataSets/ds002/data"
        dic_data = json.loads(
        json.dumps(BVA.path_hierarchy(test1), indent=2, sort_keys=True))
        names = BVA.get_name_in_dir([dic_data], names)
    ...
    def test_bids_dataset_3(self):
        names=list()
        test1=PATH+"/Tests/DataSets/ds003/data"
        dic_data = json.loads(
        json.dumps(BVA.path_hierarchy(test1), indent=2, sort_keys=True))
        names = BVA.get_name_in_dir([dic_data], names)
        self.assertEqual(BVA.is_bids(names), False)
    ...
    def test_bids_dataset_3(self):
        names=list()
        test1=PATH+"/Tests/DataSets/ds004/data"
        dic_data = json.loads(
        json.dumps(BVA.path_hierarchy(test1), indent=2, sort_keys=True))
        names = BVA.get_name_in_dir([dic_data], names)
        self.assertEqual(BVA.is_bids(names), False)
    ...
    def test_bids_dataset_3(self):
        names=list()
        test1=PATH+"/Tests/DataSets/ds005/data"
        dic_data = json.loads(
        json.dumps(BVA.path_hierarchy(test1), indent=2, sort_keys=True))
        names = BVA.get_name_in_dir([dic_data], names)
        self.assertEqual(BVA.is_bids(names), False)
